...
#if __has_include(<applink.c>)
#include <applink.c>
#endif
#if __has_include(<openssl/applink.c>)
...
inline X509_STORE *ClientImpl::create_ca_cert_store(const char *ca_cert,
  ...
  auto mem = BIO_new_mem_buf((void*)ca_cert, static_cast<int>(size));
